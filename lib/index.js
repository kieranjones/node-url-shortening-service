...
app.get('/shorten', function (req, res, next) {
	...
	pg.connect(process.env.DATABASE_URL, function (err, client, done) {
		...
		var query = client.query('INSERT INTO shorturls (long_url, created_date, creator_ip, creator_user_id, referrals) values ($1, $2, $3, $4, $5) RETURNING id', [urlParam, dateCreated, '202.023.222.143', 1, 0], function (err, result) {
